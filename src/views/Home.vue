      ...
      <div id="MenuBurg">
       <div id="MenuInner">
           ...
           <p>
               ...
               <input type="text" id="name" v-model="na" required="required" placeholder="First and last name">
           </p>
           ...
           <p>
               <label for="payment">Payment of choice</label><br>
    ...
    sendInfoClick: function (){
      console.log(
        ...
        socket.emit("addOrder", { orderId: this.getOrderNumber(),
                                ...
                                customer :{name: this.na, email: this.mail, payment: this.payment, gender: this.gender}
                              }
                 );
    }
  }
